...
Call log:
  - waiting for locator('iframe[name="itemscope"]').contentFrame().getByRole('option', { name: 'Online' }) to be visible
    ...
    at M:\PlaywrightStuff\src\tests\filemanager.test.ts:23:9
  ...
  - list:
    ...
    - listitem:
      ...
      - list:
        ...
        - listitem:
          - img: 
          - button "TEST Scenario bug [SWIS-313]"
        - listitem:
          - img: 
          - button "test-ev"
        - listitem:
        ...
        - listitem:
          - img: 
          - button "TEST briefing format [UBER-186]"
        - listitem:
          - img: 
          - button "15052024 Scenario 2"
        - listitem:
          - button "Expand Folder": 
          - img: 
          - button "Hierarchy Language [14]"
        - listitem:
          - img: 
          - button "AHA_GENERAL"
        - listitem:
          - button "Expand Folder": 
          - img: 
          - button "Folder inherit permission [6]"
        - listitem:
          - button "Expand Folder": 
          - img: 
          - button "Folder no inherit [3]"
        - listitem:
          - img: 
          - button "73372 Briefing"
        - listitem:
          - img: 
          - button "123 new item"
        - listitem:
        ...
        - listitem:
          - button "Expand Folder": 
          - img: 
          - button "Vlad's folder [14]"
        - listitem:
          - img: 
          - button "version list test"
        - listitem:
          - img: 
          - button "PlanSource 2023"
        - listitem:
          - img: 
          - button "item for test glossary"
        - listitem:
          - button "Expand Folder": 
          - img: 
          - button "MB [10]"
        - listitem:
          - img: 
          - button "Kaiser Medical Plan For California Employees Only"
        - listitem:
          - img: 
          - button "Content Manager – Part 22 Agenda"
        - listitem:
          - img: 
          - button "test item with translations (from trash bin)"
        - listitem:
          - img: 
          - button "ert"
        - listitem:
        ...
        - listitem:
          - button "Expand Folder": 
          - img: 
          - button "Artemii's folder [12]"
        - listitem:
          - img: 
          - button "DIRECT BILL / SPM GUIDE SPM Qualifying Beneficiaries & Events"
        - listitem:
          - img: 
          - button "New Item"
        - listitem:
        ...
        - listitem:
          - img: 
          - button "ttyrtyrtyrtyg"
        - listitem:
          - img: 
          - button "vlad image item"
        - listitem:
          - img: 
          - button "ttruuuth"
        - listitem:
        ...
        - listitem:
          - img: 
          - button "Nuevo elemento"
        - listitem:
          - img: 
          - button "BrandSafway 2023 Open Enrollment Benefits Overview"
        - listitem:
          - img: 
          - button "Vlad Online Item 1747060749938"
        - listitem:
          - img: 
          - button "New Item"
        - listitem:
