...
Expected string: "https://kmsqacm.lighthouse-cloud.comhttps//kmsqacm.lighthouse-cloud.com/kms/lh"
Received string: "https://kmsqacm.lighthouse-cloud.com/kms/lh/"
Call log:
  - expect.toHaveURL with timeout 5000ms
  - waiting for locator(':root')
    9 × locator resolved to <html lang="en">…</html>
      - unexpected value "https://kmsqacm.lighthouse-cloud.com/kms/lh/"

    at LoginVlad.expectUrl (M:\PlaywrightStuff\src\pages\basePage.ts:59:29)
    at LoginVlad.CMLogin (M:\PlaywrightStuff\src\pages\Loginvlad.ts:80:16)
    at Object.authCM (M:\PlaywrightStuff\src\fixtures.ts:60:5)
```
...
- img "KMS lighthouse"
- img "KMS lighthouse"
- heading "Choose a layout" [level=1]
- button "Please choose a layout": Content Manager
- combobox "Please choose a layout":
  - option "Content Manager" [selected]
  - option "Administrator"
  - option "Manager"
- img: 
- button "Please choose a layout": Login
```
