...
============================================================
    at LoginVlad.goToLayout (M:\PlaywrightStuff\src\pages\Loginvlad.ts:70:21)
...
```ts
  ...
  69 |     await this.click(this.layoutButton);
> 70 |     await this.page.waitForURL(new RegExp(process.env.LAYOUT_URL), { waitUntil: 'load', timeout: 15000 });
     |                     ^ Error: page.waitForURL: Target page, context or browser has been closed
  71 |     await this.expectUrl(/LAYOUT/);
  72 |   }
  73 | }
```